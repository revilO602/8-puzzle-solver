...
class Node:
    ...
    # Overriding this function helps heapq by allowing equality and setting self.value as the comparable attribute
    ...
    # Create all the possible children nodes with operators LEFT, RIGHT, UP, DOWN (moving the blank)
    # Excludes making the parent
    def make_children(self, rows_am, cols_am):
        children = []
        mover_y, mover_x = find_mover(self.state)
